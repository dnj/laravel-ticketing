...
class TicketMessageControllerTest extends TestCase
{
    ...
    public function testStore(): void
    {
        ...
        $this->postJson(route('tickets.messages.store', ['ticket' => $ticket->id]))
            ->assertStatus(401);
        ...
        $this->postJson(route('tickets.messages.store', ['ticket' => $ticket->id]), $ticketData)
            ->assertStatus(201)
            ->assertJson(function (AssertableJson $json) {
    ...
    public function testUpdate(): void
    {
        ...
        $this->putJson(route('tickets.messages.update', ['ticket' => 3, 'message' => 2]))
            ->assertStatus(401);
        ...
        $this->putJson(route('tickets.messages.update', ['ticket' => 50, 'message' => 100]), $messageData)
            ->assertStatus(404);


        $this->putJson(route('tickets.messages.update', ['ticket' => 1, 'message' => 2]))
            ->assertStatus(422)
            ->assertJson(function (AssertableJson $json) {
                $json->hasAll(["message", "errors", "errors.message"]);
            });
        ...
        $this->putJson(route('tickets.messages.update', ['ticket' => 1, 'message' => 2]), $messageData)
            ->assertStatus(200)
    ...
    public function testDestroy(): void
    {
        ...
        $this->deleteJson(route('tickets.messages.destroy', ['ticket' => 2, 'message' => 1]))
            ->assertStatus(401);
        ...
        $this->deleteJson(route('tickets.messages.destroy', ['ticket' => 20, 'message' => 50]))
            ->assertStatus(404);
